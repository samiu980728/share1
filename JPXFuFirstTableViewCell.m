...
- (void)layoutSubviews
{
    _imageCell1.frame = CGRectMake(0, 0, 60, 60);
    
    _mainString.frame = CGRectMake(66, 0, 30, 30);
    
    _mainString.font = [UIFont systemFontOfSize:18];
    
    _detailString1.frame = CGRectMake(200, 0, 100, 30);
    
    _detailString1.font = [UIFont systemFontOfSize:13];
    
    _detailString2.frame = CGRectMake(66, 35, 25, 80);
    
    _detailString2.font = [UIFont systemFontOfSize:15];
    
    _detailString3.font = [UIFont systemFontOfSize:15];
    
    _detailString3.frame = CGRectMake(0, 0, 300, 30);
