...
//    }
//    // 然后再进行present操作
//    [topRootViewController presentViewController:self animated:YES completion:nil];
    
    
    
    //[titleView addSubview:_tableView];
    
    //[self performSelector:@selector(layout) withObject:nil afterDelay:0.0f];
    [self layout];
    
//    NSTimer * timer = [NSTimer scheduledTimerWithTimeInterval:3.0 target:self selector:@selector(layout) userInfo:nil repeats:NO];
...
////
        ...
        cell1.btnSet.tintColor = [UIColor blackColor];
